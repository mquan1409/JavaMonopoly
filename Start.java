...
public class Start {
    ...
    public static void Rent(){
        ...
        JOptionPane.showMessageDialog(null, "Player ".concat(String.valueOf(turn + 1)).concat(" rent ").concat("Player ").concat(String.valueOf(deed.GetOwnerId() + 1)).concat(" with $").concat(String.valueOf(rent_cost)));
    }
    ...
    public static void BuyHouses(){
        ...
        if(deed.GetNumHouses() < 4){
            ...
            if(hotel_confirm == 0){
                ...
                players[turn].SetMoneyOwned(players[turn].GetMoneyOwned() - (deed.GetHouseCost()));
    ...
    public static void SellHouses(){
        ...
        if(deed.GetNumHouses() == 5){
            ...
            if(hotel_confirm == 0){
                deed.SetNumHouses(deed.GetNumHouses() - 1);
                players[turn].SetMoneyOwned(players[turn].GetMoneyOwned() + deed.GetHouseCost() * 1/2);
                LayeredPane.UpdateHouses(deed);
            }
            sellhotelable = true;
        }
        ...
        else if(!sellhouseable && ! sellhotelable){
