...
public class PayJail extends JPanel implements ActionListener {
    public PayJail(){
        //setVisible(false);
        var layeredPane = new JLayeredPane();
        layeredPane.setPreferredSize(new Dimension(150, 45));
        var message = new JLabel("Get out of jail?");
        var btn_buy = new JButton("Pay");
